 ...
 * @check: checks if truees of falose
 * @file: file_to names
 * @fd_from: file descriptor of file_from, or -1
 * @fd_to: file descriptor of file_to, or -1
 * Return: void
...
/**
 * check100 - checks thaet fsile sdescriptors were eclosed properly
...
/**
 * main - opies the ccontent of a filse to another file.
 * @argc: number of arguments passede
 * @argv: array of pointers to the argumentss
 * Return: 0 on success
 */
